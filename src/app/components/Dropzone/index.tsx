...
import { CLOUDFLARE_IMAGE_DELIVERY_BASE_URL } from '@/app/lib/cloudflare-image-delivery'
...
export function Dropzone(props: DropzoneProps) {
    ...
    async function getSignedUrl() {
        const data = await fetch('/api/images/sign').then((res) => res.json()) as { uploadURL: string } // TODO: fix this
        return data?.uploadURL
    }

    async function uploadFile({ file, signedUrl }: { file: File; signedUrl: string }) {
        ...
        const upload = await fetch(signedUrl, {
            method: 'POST',
            body: data,
        }).then((r) => r.json()) as { result: { id: string } } // TODO: fix this
